 ...
 *           |     +atmega328P                       |
 *           |---------------------------------------|
 *           |                                  PC0  |23 BACKLIGHT/DB0
 *        4  | VCC_2                            PC1  |24 ROTA/DB1
 *        6  | VCC                              PC2  |25 ROTB/DB2
 *        18 | AVCC                             PC3  |26 DB3
 *           |                                  PC4  |27 SDA/RS
 *        19 | ADC6                             PC5  |28 SCL/EN
 *        22 | ADC7                             PC6  |29  #RESET
 *        20 | AREF                                  |
 *  LED1  12 | PB0                              PD0  |30 RXD
 *  SRV-1 13 | PB1(OC1A)                        PD1  |31 TXD
 *  SRV-2 14 | PB2(OC1B)                        PD2  |32 DE
 *  MOSI  15 | PB3                              PD3  | 1 COIL1+
 *  MISO  16 | PB4                              PD4  | 2 COIL1-
 *  SCK   17 | PB5                              PD5  | 9 COIL2+
 *  XTAL1 7  | PB6                              PD6  |10 COIL2-
 *  XTAL2 8  | PB7                              PD7  |11 LED2
*         3  | GND-2                                 |
*         5  | GND-3                                 |
*         21 | GND                                   |
*            +---------------------------------------+
